...
import { faUsers, faChartBar, faGlobe, faMobileAlt } from "@fortawesome/pro-duotone-svg-icons"
    ...
    <section className="py-20 md:py-28 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-sm font-semibold text-accent uppercase tracking-wider mb-2 block">What's Next</span>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">Help us build Genwel</h2>
          <p className="text-lg text-muted-foreground mb-6">
            We're building in public and want your input. Here's what's coming—and we'd love your ideas.
          </p>
