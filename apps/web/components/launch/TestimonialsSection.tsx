...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote: "No other budgeting app understood that sometimes you're starting from minus. Genwel met me where I was.",
      rating: 5,
    },
  ]
  ...
  return (
    <section ref={ref} id="testimonials" className="py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground text-balance">Real Stories, Real Progress</h2>
            ...
            <motion.div key={index} variants={itemVariants}>
              <Card className="h-full bg-card hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  <FontAwesomeIcon icon={faQuoteLeft} size="lg" className="text-primary/30 mb-4" />
